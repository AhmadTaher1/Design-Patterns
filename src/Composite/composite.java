...
class Neuron implements SomeNeurons
{
  ...
  public Iterator<Neuron> iterator()
  {
    ...
    return Collections.singleton(this).iterator(); //create an iterator for this single neuron
  }
...
class NeuralNetworksDemo
{
  public static void main(String[] args)
  {
    ...
    //thus all these cases are covered and single neuron  and layer can be used interchangeably and treated equally
